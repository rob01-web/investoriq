...
const { buildPhase8CertificationRequests, renderPhase8CertificationArtifacts } = await import("./phase8-visual-certification-fixtures.js");
...
for (const lane of ["screening", "underwriting"]) {
  ...
  const expectedClass = lane === "screening" ? /class="card allow-break phase8b-screening-decision-page"/ : /class="card allow-break iq-ic-summary-card phase8a-executive-summary"/;

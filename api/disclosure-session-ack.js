...
export default async function handler(req, res) {
  try {
    ...
    const sessionIdentifier = auth.sessionIdentifier;
    const sessionIdentifierSource = auth.sessionIdentifierSource || 'unknown';
    const ip =
    ...
    console.error('disclosure-session-ack error:', err);

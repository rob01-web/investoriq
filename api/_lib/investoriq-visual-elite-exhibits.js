...
.iq-phase8b [data-iq-elite06-surface="diligence-coverage"] .summary-strip { display:grid !important; grid-template-columns:repeat(4,minmax(0,1fr)); gap:0; margin:0 0 14px; border-top:1px solid var(--iq-ve-rule-strong); border-bottom:1px solid var(--iq-ve-gold-soft); }
...
.iq-phase8b [data-iq-elite06-surface="diligence-coverage"] .summary-strip span { display:block; font-family:var(--font-mono); font-size:5.4pt; font-weight:500; letter-spacing:.07em; text-transform:uppercase; color:var(--iq-ve-muted); }
...
.iq-phase8b .iq-ve-exhibit-heading span { display:block; font-family:var(--font-mono); font-size:5.6pt; font-weight:500; letter-spacing:.09em; text-transform:uppercase; color:var(--iq-ve-muted); }
...
.iq-phase8b .iq-scenario-label { display:inline-block; margin:0 0 7px; padding:3px 6px; border:1px solid #d9c995; font-family:var(--font-mono); font-size:5.2pt; font-weight:500; letter-spacing:.06em; text-transform:uppercase; color:#6d5c31; background:#fbf8ee; }
.iq-phase8b [data-iq-evidence-class="source_backed"] { color:#29483e; }
.iq-phase8b .iq-evidence-label { display:inline-block; font-family:var(--font-mono); font-size:5pt; font-weight:500; letter-spacing:.035em; color:var(--iq-ve-muted); white-space:nowrap; }

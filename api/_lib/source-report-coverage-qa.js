...
function findRenderedSignals(html) {
  ...
  const signalPatterns = [
    ...
    ["dscr_current_debt_not_assessed", /Current debt service is not assessed|Current debt service not assessed|No current debt document provided|Current debt terms were not fully provided/i],

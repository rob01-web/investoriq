...
import { runSourcePackageQaAdvisory } from "./source-package-qa.js";
import { runQaManagerReview } from "./qa-manager-review.js";
import { buildQaDirectorReview } from "./qa-director-review.js";
import { buildReportContractQa } from "./report-contract-qa.js";
...
} from "./acquisition-memo-v2-document.js";
...
finalHtml = replaceAll(finalHtml, "{{UNIT_POSITIONING_SECTION_SUBTITLE}}", rentPositioningSectionLabel.subtitle);
    ...
    const screeningVisibleClassificationForConsumers =
      effectiveReportMode === "screening_v1"
        ...
        : "";
    if (effectiveReportMode === "screening_v1") {
      const screeningFinalization = screeningReportRenderer.buildScreeningCustomerOutput({
        finalHtml,
        reportMode: effectiveReportMode,
    ...
    if (effectiveReportMode === "screening_v1" && screeningVisibleClassificationForConsumers) {
      ...
      capRateValueIndicationBlockHtml = buildCapRateValueTable(
        ...
        { formatCurrency, formatCapPercentExact }
      );
      ...
      effectiveReportMode === "screening_v1"
        ...
        : (() => {
            ...
            const financingEnvelopeHtml = refiDebtRenderStateForScreeningBlock.allowDebtMath
              ? screeningReportRenderer.buildFinancingEnvelopeGrid(
                  coerceNumber(t12Payload?.net_operating_income),
  ...
  : "";
    ...
    if (effectiveReportMode === "screening_v1") {
      const screeningFinalization = screeningReportRenderer.buildScreeningCustomerOutput({
        ...
        t12NoiValue,
        t12ExpenseRatioValue,
        buildFinancingEnvelopeGrid: screeningReportRenderer.buildFinancingEnvelopeGrid,
  ...
  if (!isSealedCustomerOutput) {
    ...
    const docFinalSourceReconciliationGuardHasMismatch =
      docFinalSourceReconciliationGuard.render_state?.renderable
        ? docFinalSourceReconciliationGuard.matched_displays_after.some(
            (display) => display !== docFinalSourceReconciliationGuard.render_state?.variance_display
          ) ||

        ...
        columns: [
          {
            ...
            stack: [
              ...
              {
                text: `Report generated by the document-based underwriting framework on ${fmt.date(
                  generatedAt
                )}`,
                style: "finePrint",
              ...
              },
              {
                table: {
                  ...
                  body: [
                    ...
                    ["View", hasScore && band ? band.label : dataNotAvailableBlock()],
                  ],
                },
                layout: "lightHorizontalLines",
                margin: [0, 0, 0, 16],
                ...
                table: {
                  ...
                  body: [
                    [
                      ...
                      { text: "Commentary", style: "tableHeader" },
...
function analystCommentaryPage(data) {
  ...
  if (!hasNotes) {
    return {
      stack: [
        { text: "", pageBreak: "before" },
        sectionTitle("Commentary", "Framework-driven view for investment committees and partners."),
        dataNotAvailableBlock(),
      ],
    };
  }

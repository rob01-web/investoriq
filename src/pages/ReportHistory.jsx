  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Track and download your previously generated InvestorIQ Reports."
        />
      </Helmet>

      <div className="min-h-screen bg-gradient-to-b from-white via-[#F9FAFB] to-[#EEF2F5] p-6 sm:p-10 flex flex-col">
        <motion.div
        ...
        >
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-slate-600 mt-2 text-lg">
              Review, manage, and download your past IQ Reports.
            </p>
          ...
          {loading ? (
            <div className="flex flex-col items-center justify-center py-24">
              ...
              <p className="text-slate-600 text-lg">Fetching your reports...</p>
            </div>
          ) : reports.length === 0 ? (
            <motion.div
              initial={{ opacity: 0 }}
            ...
            >
              ...
              <h3 className="text-xl font-bold text-[#0F172A] mb-1">No Reports Yet</h3>
              <p className="text-slate-600 mb-6">
                Upload your first property deal to generate your first InvestorIQ Report.
              </p>
              <Button
              ...
              <table className="w-full border-collapse rounded-xl overflow-hidden">
                <thead>
                  <tr className="bg-gradient-to-r from-[#1F8A8A]/10 to-[#D4AF37]/10 text-left text-[#0F172A] text-sm font-semibold">
                    <th className="p-4 border-b border-slate-200">Property Address</th>
        ...
        <footer className="py-6 border-t bg-white text-center text-slate-500 text-sm mt-12">

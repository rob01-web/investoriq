...
## Admin quality and remedy-specific lock

RETEST 38 must remain a permanent InvestorIQ-owned incident family because valid core evidence and a deliverable canonical decision still resulted in no customer report. The Manifest and Admin Dashboard must preserve the distinction between:

```text
content eligible and deliverable
PDF artifact rendered
PDF certification failed
bounded recomposition skipped by internal eligibility defect
publication withheld
credit restored
```

The customer must not be blamed for this failure. The correct responsibility is InvestorIQ platform defect. The remedy remains credit restoration, free corrected rerun after safe repair, internal review, and permanent regression coverage.

The Report History UI repair is now verified and protected. Failed reports may never disappear from the customer's canonical history surface again.

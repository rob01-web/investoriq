...
assert.equal(contract.metrics.operatingCostCoverageRatio.value, 555000 / 1612800);
assert.equal(contract.metrics.operatingCostCoverageRatio.label, "Operating Cost Coverage Ratio");
assert.equal(contract.metrics.operatingCostCoverageRatio.formula, "total_operating_expenses / gross_potential_rent");
assert.equal(contract.metrics.breakEvenOccupancy, undefined);
assert.equal(contract.metrics.occupancyBreakEvenSpread, undefined);

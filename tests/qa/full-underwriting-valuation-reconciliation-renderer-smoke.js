...
check(html.includes("NOI / Cap-Rate Cross-Check"), "accepted-basis cross-check rendered");
check(!html.includes("Accepted-Basis Value Indication"), "section does not imply an independent valuation opinion");
...
check(html.includes("NOI / Cap-Rate Cross-Check Value"), "deterministic cross-check value rendered");
...
check(html.includes('data-iq-subsection="governed-cap-rate-value-sensitivity"'), "defined sensitivity rendered");

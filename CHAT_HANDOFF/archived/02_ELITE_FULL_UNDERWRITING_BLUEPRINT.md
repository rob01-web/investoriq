...
**Created:** 2026-08-19  
**Status:** ACTIVE PRODUCT-QUALITY WORKING AUTHORITY  
...
## ELITE-02 — Investment Committee Overview Upgrade
Implement:
...
## ELITE-03 — Operating Intelligence Upgrade
Implement:
- revenue quality,
- expense structure,
- NOI analysis,
...
## ELITE-06 — Transaction Terms & Diligence
Implement:
- structured terms,
- conditions,
...
## ELITE-07 — Debt Intelligence Upgrade
Implement:
- DSCR sensitivity,
- rate sensitivity,
- maturity context,
...
**Next implementation task: ELITE-02 — Investment Committee Overview Upgrade.**

Before editing code:
1. inspect the current Executive Summary / Key Metrics / Underwriting Observations / Primary Constraint inputs,
2. identify which canonical facts already exist,
3. identify any additional deterministic calculations that can be safely derived,
4. design the exact new Executive Investment Summary contract,
5. implement locally,
6. verify against current Publish-or-Collapse behavior,
7. do not deploy until explicitly authorized.
